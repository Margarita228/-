...
namespace СалонКрасоты {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("ПарикмахерскаяDataSet10")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class ПарикмахерскаяDataSet10 : global::System.Data.DataSet {
        ...
        public ПарикмахерскаяDataSet10() {
            this.BeginInit();
            this.InitClass();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected ПарикмахерскаяDataSet10(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            ПарикмахерскаяDataSet10 cln = ((ПарикмахерскаяDataSet10)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "ПарикмахерскаяDataSet10";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ПарикмахерскаяDataSet10.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            ПарикмахерскаяDataSet10 ds = new ПарикмахерскаяDataSet10();
        ...
        public partial class КлиентыDataTable : global::System.Data.TypedTableBase<КлиентыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public КлиентыRow AddКлиентыRow(int Код_клиента, string ФИО, bool Пол, string Номер_телефона, string Категория) {
        ...
        public partial class КлиентыRow : global::System.Data.DataRow {
            ...
            public bool Пол {
                get {
                    try {
                        return ((bool)(this[this.tableКлиенты.ПолColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace СалонКрасоты.ПарикмахерскаяDataSet10TableAdapters {
    ...
    public partial class КлиентыTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Клиенты] WHERE (([Код клиента] = @Original_Код_клиента) AND ((@IsNull_Пол = 1 AND [Пол] IS NULL) OR ([Пол] = @Original_Пол)) AND ((@IsNull_Номер_телефона = 1 AND [Номер телефона] IS NULL) OR ([Номер телефона] = @Original_Номер_телефона)) AND ((@IsNull_Категория = 1 AND [Категория] IS NULL) OR ([Категория] = @Original_Категория)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Клиенты] ([Код клиента], [ФИО], [Пол], [Номер телефона], [Категория]) VALUES (@Код_клиента, @ФИО, @Пол, @Номер_телефона, @Категория);
SELECT [Код клиента], ФИО, Пол, [Номер телефона], Категория FROM Клиенты WHERE ([Код клиента] = @Код_клиента)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Клиенты] SET [Код клиента] = @Код_клиента, [ФИО] = @ФИО, [Пол] = @Пол, [Номер телефона] = @Номер_телефона, [Категория] = @Категория WHERE (([Код клиента] = @Original_Код_клиента) AND ((@IsNull_Пол = 1 AND [Пол] IS NULL) OR ([Пол] = @Original_Пол)) AND ((@IsNull_Номер_телефона = 1 AND [Номер телефона] IS NULL) OR ([Номер телефона] = @Original_Номер_телефона)) AND ((@IsNull_Категория = 1 AND [Категория] IS NULL) OR ([Категория] = @Original_Категория)));
SELECT [Код клиента], ФИО, Пол, [Номер телефона], Категория FROM Клиенты WHERE ([Код клиента] = @Код_клиента)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Код клиента], ФИО, Пол, [Номер телефона], Категория FROM dbo.Клиенты";
        ...
        public virtual int Fill(ПарикмахерскаяDataSet10.КлиентыDataTable dataTable) {
        ...
        public virtual ПарикмахерскаяDataSet10.КлиентыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ПарикмахерскаяDataSet10.КлиентыDataTable dataTable = new ПарикмахерскаяDataSet10.КлиентыDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ПарикмахерскаяDataSet10.КлиентыDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ПарикмахерскаяDataSet10 dataSet) {
        ...
        public virtual int Delete(int Original_Код_клиента, global::System.Nullable<bool> Original_Пол, string Original_Номер_телефона, string Original_Категория) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Код_клиента));
            if ((Original_Пол.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((bool)(Original_Пол.Value));
            }
            else {
        ...
        public virtual int Insert(int Код_клиента, string ФИО, global::System.Nullable<bool> Пол, string Номер_телефона, string Категория) {
        ...
        public virtual int Update(int Код_клиента, string ФИО, global::System.Nullable<bool> Пол, string Номер_телефона, string Категория, int Original_Код_клиента, global::System.Nullable<bool> Original_Пол, string Original_Номер_телефона, string Original_Категория) {
            ...
            if ((Original_Пол.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((bool)(Original_Пол.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, global::System.Nullable<bool> Пол, string Номер_телефона, string Категория, int Original_Код_клиента, global::System.Nullable<bool> Original_Пол, string Original_Номер_телефона, string Original_Категория) {
            return this.Update(Original_Код_клиента, ФИО, Пол, Номер_телефона, Категория, Original_Код_клиента, Original_Пол, Original_Номер_телефона, Original_Категория);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(ПарикмахерскаяDataSet10 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(ПарикмахерскаяDataSet10 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(ПарикмахерскаяDataSet10 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._клиентыTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(ПарикмахерскаяDataSet10 dataSet) {
            if ((dataSet == null)) {
