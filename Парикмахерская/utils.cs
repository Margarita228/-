...
namespace СалонКрасоты
{
    internal class utils
    {
        ...
        public static void pdfWriter(string file, string[] tableNames, List<string[]>[] data, string[][] columns)
        {
            ...
            PdfWriter.GetInstance(pdf, new FileStream($"D:\\pdfDocuments\\{file}.pdf", FileMode.Create));
            pdf.Open();
            ...
            pdf.Close();
            System.Diagnostics.Process.Start($"D:\\pdfDocuments\\{file}.pdf");
        }

        // Запись данных в CSV
        public static void csvWriter(string file, List<string[]> data, string[] columns)
        {
            string _data = "";
            ...
            StreamWriter sw = new StreamWriter($"D:\\csvDocuments\\{file}.csv", false, Encoding.GetEncoding("windows-1251"));
            sw.Write(_data);
            sw.Close();
        }
    }
